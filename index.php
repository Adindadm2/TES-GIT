        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">APLIKASI<span class="logo-dec"> ARSIP SURAT</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="staff/login"><i class="fa fa-sign-out pull-right"></i> Staff</a></li>
                  </ul>
                </li>
              </ul>
              </ul>
        ...
        <div class="container">
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <div class="logo">
		            <img src="img/palcomtech.jpeg" alt="" />
	            </div>
              <h3 class="bnr-sub-title">SISTEM INFORMASI PENGARSIPAN SURAT</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec"></span></h3>
            </div>
          </div>
        </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">"Kesuksesan berasal dari kerja sama sebuah TIM"</p>
            <hr class="bottom-line">
          </div>
          <div class="col-md-3"></div>
          <div class="col-md-6 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
            <figure>
              <img src="img/Pengembang.jpg" class="img-responsive">
              <figcaption>
              		<h1>TUGAS KELOMPOK</h1>
               	        <h3>Pemrograman Web Dasar</h3>
			<h3>INSTITUT TEKNOLOGI BISNIS PALCOMTECH</h3>
        ...
        <div class="row">
          <div class="testimonial-item">
            <ul class="bxslider">
              <li>
                <blockquote>
                  <img src="img/arsip.jpeg" class="img-responsive">
                  <p>ADINDA DWI MAHARANI (011200069). </p>
                </blockquote>
              ...
              <li>
                <blockquote>
                  <img src="img/arsip.jpeg" class="img-responsive">
                  <p>AGUNG EKA PURNOMO (011200016).</p>
                </blockquote>
                <small>TEKNIK INFORMATIKA</small>
              </li>
              <li>
    ...
    <footer id="footer">
      <div class="container">
        <div class="row text-center">
          <p>&copy; INSTITUT TEKNOLOGI BISNIS PALCOMTECH. All Rights Reserved.</p>
          <div class="credits">
            <!-- 
